...
// func GetAdminConnection(cluster *ksengine.ShepherdCluster) ConnectionObject {
// 	if sca == nil {
...
// 	for _, cluster := range ksengine.SpdCore.Configs.ConfigRoot.Clusters {
